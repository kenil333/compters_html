...
function C1story() {
    return (
        <div className="testimonials__storysection">
            ...
            <p className="testimonials__storysection__text1">Alex runs a bike store in San Antonio,Texas and approached us for Bookkeeping for his firm. The business was in a very nascent stage and they had a bookkeeper who used to help them but they faced issues of having consistent and reliable financials ready on time. We understood their business, cleared all the backlog, and are helping them keep their books updated regularly.</p>
            <p className="testimonials__storysection__text1">After the books were updated and consistent , He also asked us if we could help him understanding the financial situation of the business and help in understand different numbers. We were delighted for this project and helped us thru our finance services. We helped them with the following models:</p>
            ...
            <p className="testimonials__storysection__text2"><span style={{fontSize: '30px'}}>"</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Our understanding of financial statements and simplifying different numbers into relavant reports have helped Alex and his team in their business. We thanks Alex and his team for this opportunity.</p>
        </div>
    )
}
